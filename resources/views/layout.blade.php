...
<div class="content">
	...
	<div class="pre-header">
		<div class="container">
			<a href="{{$firstBanner->link}}"><img src="{{asset('storage/'.$firstBanner->cover)}}"
			                                      style="height: 49px;width: 100%" class="img-fluid" alt=""></a>
		</div>
	</div>
	@endif
				...
				<div class="col-xl-3 col-sm-2">
					...
					<div class="app-btn">
						...
						<a href="{{$item->link}}" target="_blank">
							<img style="height:44px !important;width:118px !important"
							     src="{{asset('storage/'.$item->linkTypes->name)}}.png?v=2" alt="">
						</a>
						@endif
						@endforeach
					</div>
					...
					<div class="row">
						...
						<div class="col-xl-8">
							<div class="search">
								...
								<a style="margin-left: 10px;cursor: pointer;" onclick="header_search()"><img
